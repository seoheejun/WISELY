...
public class MemberDTO {
	...
	public MemberDTO(int memNo, String memName, String memEmail, String memPw, String memZipcode, String memRoadAddr, String memJibunAddr, String memDetailAddr) {
		super();
		this.memNo = memNo;
	...
	public MemberDTO(String memName, String memEmail, String memPw, String memZipcode, String memRoadAddr, String memJibunAddr, String memDetailAddr) {
		super();
		this.memName = memName;
		this.memEmail = memEmail;
		this.memPw = memPw;
	...
	public String toString() {
		return "MemberDTO [memNo=" + memNo + ", memName=" + memName + ", memEmail=" + memEmail + ", memPw=" + memPw
				+ ", memZipcode=" + memZipcode + ", memRoadAddr=" + memRoadAddr + ", memJibunAddr=" + memJibunAddr
				+ ", memDetailAddr=" + memDetailAddr + "]";
	}
}
